...
struct DebugPane: View {
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: true) {
            VStack(alignment: .leading, spacing: 20) {
                SettingsSection(title: L10n.sectionLogging) {
                    PreferenceToggleRow(
                ...
                SettingsSection(
                    title: L10n.sectionProbeLogs,
                    caption: L10n.probeLogsSubtitle)
                {
                    ...
                    Button {
                        ...
                        Label(L10n.rerunAutodetect, systemImage: "dot.radiowaves.left.and.right")
                    }
                    .controlSize(.small)
                ...
                SettingsSection(
                    title: L10n.sectionFetchStrategy,
                    caption: L10n.fetchStrategySubtitle)
                {
                ...
                if !self.settings.debugDisableKeychainAccess {
                    SettingsSection(
                        title: L10n.sectionOpenAICookies,
                        caption: L10n.openAICookiesSubtitle)
                    {
                        HStack(spacing: 12) {
                            Button {
                ...
                SettingsSection(
                    title: L10n.sectionCaches,
                    caption: L10n.clearCostCacheSubtitle)
                {
                ...
                SettingsSection(
                    ...
                    caption: L10n.notificationsSubtitle)
                {
                    Picker("Provider", selection: self.$currentLogProvider) {
                        Text("Codex").tag(UsageProvider.codex)
                        Text("Claude").tag(UsageProvider.claude)
                ...
                #if DEBUG
                SettingsSection(
                    title: L10n.sectionErrorSimulation,
                    caption: L10n.errorSimulationSubtitle)
                {
                ...
                SettingsSection(
                    title: L10n.sectionCLIPaths,
                    caption: L10n.cliPathsSubtitle)
                {
    ...
    private var displayedLog: String {
        if self.logText.isEmpty {
            return self.isLoadingLog ? L10n.loading : L10n.noLogYet
        }
        return self.logText
    }
